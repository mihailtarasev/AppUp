...
public class ActiveAppActivity extends Activity {
	...
	public void onCreate(Bundle si) {
		...
		tvTitle.setText(getString(R.string.ack_app));
		...
		ab = getActionBar();
		ColorDrawable abBack = new ColorDrawable(getResources().getColor(
				R.color.actionbar_color));
		ab.setBackgroundDrawable(abBack);
		...
		pullToRefreshView
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView parent,
						...
						Intent i = new Intent(ActiveAppActivity.this,
	...
	public void onBackPressed() {
		Intent i = new Intent(ActiveAppActivity.this, MainScreenActivity.class);
		startActivity(i);
	}
	...
	class LoadResponse extends AsyncTask<Void, Void, List<NewAppListElement>> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = new ProgressDialog(ActiveAppActivity.this);
